...
static const struct ipu_sensor_config ipu_supported_sensors[] = {
	...
	/*
	 * Omnivision OV5675 behind the OVTI5678 ACPI id, as fitted to the
	 * front of the Dell Latitude 7320 Detachable. 450 MHz is
	 * OV5675_LINK_FREQ_450MHZ, the single link frequency ov5675.c
	 * supports, and matches the 2 lanes reported in this machine's SSDB.
	 */
