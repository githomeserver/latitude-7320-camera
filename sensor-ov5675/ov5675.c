...
static const struct acpi_device_id ov5675_acpi_ids[] = {
	{"OVTI5675"},
	/*
	 * The front camera of the Dell Latitude 7320 Detachable is described
	 * as OVTI5678 in ACPI, but the part reports chip id 0x005675 at
	 * register 0x300a, and the SSDB agrees with this driver on both of the
	 * other values that matter: 2 CSI-2 data lanes and a 19.2 MHz external
	 * clock. Read live from that machine on 2026-08-08:
	 *
